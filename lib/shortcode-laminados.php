...
function wp_muestrarios_laminados_shortcode($params = array(), $content = null) {
  ob_start(); ?>
					...
					<div class="swiper mySwiper1 swiper-v">
						<div class="swiper-wrapper">
							<div class="swiper-slide menumosaic">
								<a href="#" class="circle" data-goto="1" style="background-image: url('/wp-content/plugins/wp-muestrario/laminados/Color/BasicosColor/221cerulean.jpg');">Básicos</a><a href="#" class="circle" data-goto="2" style="background-image: url('/wp-content/plugins/wp-muestrario/laminados/Color/CalidosColor/2295orangine.jpg');">Cálidos</a><a href="#" class="circle" data-goto="3" style="background-image: url('/wp-content/plugins/wp-muestrario/laminados/Color/FriosColor/2176turquesa.jpg');">Fríos</a><a href="#" class="circle"></a>
							</div>
	...
	<script>
		...
		jQuery("#popUpSwiperBg, #popUpSwiper > span").click(function() {
			if(jQuery("#popUpSwiperBg").hasClass("open")) {
				jQuery("#popUpSwiper").removeClass("open");
				jQuery("#popUpSwiperBg").removeClass("open");
				for (var i = 0; i <= swiper.length; i++ ) {
					if(swiper[i] != undefined) swiper[i].slideTo(0);
				}
			} else {
				jQuery("#popUpSwiper").addClass("open");
...
function wp_muestrarios_laminados_mini_shortcode($params = array(), $content = null) {
  ob_start(); ?>
...
add_shortcode('mini-muestrarios-laminados', 'wp_muestrarios_laminados_mini_shortcode');
